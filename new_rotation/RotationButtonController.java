...
public class RotationButtonController {
    ...
    public RotationButtonController(Context context,
        ...
        // ADICIONE ESTAS LINHAS AQUI NO FINAL DO CONSTRUTOR
        Log.i(TAG, "SettingsObserver: Registrando observer a partir do CONSTRUTOR.");
        mSettingsObserver.register();
        mSettingsObserver.onChange(false, null); // Isso força a primeira leitura do valor
    ...
    public void init() {
        ...
        Log.i(TAG, "SettingsObserver: Registrando o observer...");
    ...
    Log.i(TAG, "true Rotacionando automaticamente.");
    ...
    // classe para ser o observable da variavel boleana
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            Log.i(TAG, "SettingsObserver: mAutoAcceptSuggestion atualizado para " + mAutoAcceptSuggestion);
        }
    }
